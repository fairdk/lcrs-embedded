...
dmidecode_system.mock_output = textwrap.dedent("""\
    # dmidecode 2.9
    SMBIOS 2.4 present.
...
dmidecode_baseboard.mock_output = textwrap.dedent("""\
    # dmidecode 3.0
...
dmidecode_chassis.mock_output = textwrap.dedent("""\
    # dmidecode 3.0
    Getting SMBIOS data from sysfs.
    SMBIOS 2.6 present.
...
dmidecode_memory.mock_output = textwrap.dedent("""\
    # dmidecode 3.0
    Getting SMBIOS data from sysfs.
    SMBIOS 2.6 present.
...
dmidecode_processor.mock_output = textwrap.dedent("""\
    # dmidecode 3.0
    Getting SMBIOS data from sysfs.
    SMBIOS 2.6 present.
